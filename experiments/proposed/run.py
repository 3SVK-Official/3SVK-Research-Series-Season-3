"""
Proposed Method: Adaptive Edge Framework Experiment
...
def main():
    """Run adaptive edge framework experiment"""
    print("=" * 60)
    print("PROPOSED: Adaptive Edge Framework")
    print("=" * 60)
    ...
    all_metrics['controller_decisions'] = controller.decision_count
    ...
    output_file = results_dir / 'proposed_adaptive.json'
    with open(output_file, 'w') as f:
        json.dump(all_metrics, f, indent=2)
    
    print("\n" + "=" * 60)
    print("PROPOSED METHOD RESULTS (Adaptive with Calibration)")
    print("=" * 60)
    print(f"Calibrated threshold: {calibrated_threshold:.6f}")
    print(f"Validation F1: {validation_f1:.4f}")
